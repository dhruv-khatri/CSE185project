...
pip install numpy
```
Once the required libraries are installed, you can download genomesizer and enter its directory using the following commands (make sure you are in desired directory).
```
